...
const PersonalInformation = () => {
  ...
  return (
    <div>
      <BackButton label={t("personal-information-back-to-settings", "Back to Settings")} path="/a/settings" className="mb-xsmall" />
      <div className="rounded-rounded border-grey-20 pt-large pb-xlarge px-xlarge gap-y-xlarge large:max-w-[50%] flex flex-col border bg-white">
        <div className="gap-y-2xsmall flex flex-col">
          ...
          <p className="inter-base-regular text-grey-50">{t("personal-information-manage-your-medusa-profile", "Manage your storefront profile")}</p>
        </div>
