    ...
    <div className="flex w-full flex-col">
      ...
      <div className="focus-within:shadow-focus-border rounded-rounded">
        <div className="bg-grey-5 rounded-rounded shadow-border focus-within:shadow-cta relative h-10 transition-colors">
          <NextSelect
            customStyles={{
              control: "border-none absolute inset-0 bg-transparent focus-within:shadow-none !shadow-none focus-within:border-none pl-0",
          ...
          <div className="pl-xsmall pr-base inter-base-regular absolute inset-y-0 left-[92px] right-0 flex h-10 items-center">
            <AmountField
              ...
              className="remove-number-spinner leading-base text-grey-90 caret-orange-60 placeholder-grey-40 w-full bg-transparent text-right font-normal outline-none outline-0"
            />
