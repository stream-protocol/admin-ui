      ...
      <div className="flex flex-col items-center">
        ...
        {!mailSent ? (
          <>
            ...
            <Button variant="secondary" size="medium" className="mt-large w-[280px]" type="submit" loading={isLoading}>
          ...
          <div className="text-grey-60 rounded-rounded bg-grey-5 border-grey-20 p-base gap-x-small flex w-[280px] items-center border">
            <div>
              <CheckCircleFillIcon className="text-orange-50" size={20} />
            </div>
            <div className="gap-y-2xsmall flex flex-col">
              <span className="inter-base-regular">{t("reset-token-card-successfully-sent-you-an-email", "Successfully sent you an email")}</span>
            </div>
          </div>
        )}
