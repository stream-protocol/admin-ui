      ...
      <FocusModal.Main>
        <div className="flex flex-col items-center">
          <div className="mt-5xlarge flex w-full max-w-[664px] flex-col">
            <h1 className="inter-xlarge-semibold mb-large">{t("analytics-preferences-help-us-get-better", "Help us get better")}</h1>
            <p className="text-grey-50">
              ...
              <a href="https://docs.medusajs.com/usage" rel="noreferrer noopener" target="_blank" className="text-orange-60">
