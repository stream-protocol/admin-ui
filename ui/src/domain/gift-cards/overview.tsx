    ...
    <>
      <div className="flex flex-col">
        <PageDescription
          ...
          subtitle={t("gift-cards-manage", "Manage the Gift Cards of your Storefront store")}
        />
        {!isLoading ? (
          <div className="gap-y-xsmall flex flex-col">
            {getWidgets("gift_card.list.before").map((w, i) => {
              return <WidgetContainer key={i} widget={w} injectionZone="gift_card.list.before" entity={null} />;
            })}
            ...
            {getWidgets("gift_card.list.after").map((w, i) => {
              return <WidgetContainer key={i} widget={w} injectionZone="gift_card.list.after" entity={null} />;
            })}
          </div>
        ) : (
