...
const Item = ({ label, sublabel, description, className, disabled, disabledTooltip, children, ...rest }: RadioGroupItemProps) => {
  return (
    <label
      className={clsx(
    ...
    >
      {!disabled ? (
        <RadioGroupPrimitive.Item
          ...
          id={rest.value}
          disabled={disabled}
          className={clsx("radio-outer-ring outline-0", "shadow-grey-20 rounded-circle h-[20px] w-[20px] shrink-0 shadow-[0_0_0_1px]")}
        >
          ...
          <RadioGroupPrimitive.Indicator
            ...
            aria-hidden="true"
            className={clsx("shadow-orange-60 rounded-rounded absolute inset-0 shadow-[0_0_0_2px]")}
          />
        </RadioGroupPrimitive.Item>
      ) : (
  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Item
        {...rest}
        id={rest.value}
        className={clsx("radio-outer-ring outline-0", "rounded-circle h-[20px] w-[20px] shrink-0 shadow-[0_0_0_1px] shadow-[#D1D5DB]")}
      >
        <RadioGroupPrimitive.Indicator
          className={clsx(
            "indicator relative flex h-full w-full items-center justify-center",
