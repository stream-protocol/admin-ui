...
const OrderEditLine = ({ item, currencyCode, change, customerId, regionId }: OrderEditLineProps) => {
  ...
  const replaceProductVariantScreen = {
    ...
    onBack: pop,
    view: <AddProductVariant onSubmit={onReplace} customerId={customerId} regionId={regionId} currencyCode={currencyCode} isReplace />,
  };
      ...
      <div className="hover:bg-grey-5 rounded-rounded mx-[-5px] mb-1 flex h-[64px] justify-between py-2 px-[5px]">
        <div className="flex-grow-1 flex justify-center space-x-4">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center">
              {isNew && (
                <div className="text-small bg-orange-10 rounded-rounded mr-2 flex h-[24px] w-[42px] flex-shrink-0 items-center justify-center text-orange-500">
        ...
        <div className="flex min-w-[312px] items-center justify-between">
          ...
          <div className="flex h-full items-center gap-6">
            <div className={clsx("small:space-x-2 medium:space-x-4 large:space-x-6 flex", { "pointer-events-none !text-gray-400": isLocked })}>
              <div
